...
class MediaNotificationService {
    /**
     * 🚀 Notify ONLY admins about guest uploads
     */
    ...
    /**
     * 🚀 Notify admins about bulk guest uploads
     */
    public notifyAdminsAboutBulkGuestUpload(params: BulkMediaNotificationPayload): void {
        try {
